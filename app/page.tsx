			...
			<main className="flex-1">
				...
				<section className="container py-16">
					<div className="mb-8 text-center">
						...
						<p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
							Conheça alguns dos produtos artesanais disponíveis em nossa
							plataforma. Faça login para ver todos os produtos e realizar
							compras.
						</p>
					</div>
				...
				<section className="container py-16">
					<div className="mb-8 text-center">
						...
						<p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
							Conheça algumas das lojas de artesãos do norte do Brasil. Faça
							login para explorar todas as lojas e seus produtos.
						</p>
					</div>
